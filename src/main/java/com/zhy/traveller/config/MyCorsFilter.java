...
//        corsConfiguration.addAllowedOriginPattern("http://localhost:8080");//允许域名访问
//        corsConfiguration.addAllowedOriginPattern("http://127.0.0.1:8080");//允许域名访问
        corsConfiguration.addAllowedHeader("*");  //允许所有请求头
        corsConfiguration.addAllowedMethod("*");  //允许所有的请求类型
        corsConfiguration.setMaxAge(3600L);//单位秒
